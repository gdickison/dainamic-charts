...
{/* FORM END */}
      ...
      <button className={`${showInputButton} mb-6 rounded-md py-2 px-6 bg-blue-600 hover:bg-blue-800 text-gray-100 text-[1.5vw] 3xl:text-3xl`} onClick={showInputForm}>Show Input Form</button>
    </section>
  )
}
